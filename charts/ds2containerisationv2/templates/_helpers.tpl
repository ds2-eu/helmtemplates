...
*/}}
{{- define "containerisationv2.name" -}}
...
*/}}
{{- define "containerisationv2.fullname" -}}
...
*/}}
{{- define "containerisationv2.chart" -}}
...
Common labels
*/}}
{{- define "containerisationv2.labels" -}}
helm.sh/chart: {{ include "containerisationv2.chart" . }}
{{ include "containerisationv2.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
Selector labels
*/}}
{{- define "containerisationv2.selectorLabels" -}}
app.kubernetes.io/name: {{ include "containerisationv2.name" . }}
...
*/}}
{{- define "containerisationv2.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "containerisationv2.fullname" .) .Values.serviceAccount.name }}
{{- else }}
