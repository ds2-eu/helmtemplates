...
*/}}
{{- define "ds2modulebase3ctr.fullname" -}}
...
*/}}
{{- define "ds2modulebase3ctr.chart" -}}
...
Common labels
*/}}
{{- define "ds2modulebase3ctr.labels" -}}
helm.sh/chart: {{ include "ds2modulebase3ctr.chart" . }}
{{ include "ds2modulebase3ctr.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
Selector labels
*/}}
{{- define "ds2modulebase3ctr.selectorLabels" -}}
app.kubernetes.io/name: {{ include "ds2modulebase3ctr.name" . }}
...
*/}}
{{- define "ds2modulebase3ctr.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "ds2modulebase3ctr.fullname" .) .Values.serviceAccount.name }}
{{- else }}
