...
*/}}
{{- define "containerisationv24.name" -}}
...
*/}}
{{- define "containerisationv24.fullname" -}}
...
*/}}
{{- define "containerisationv24.chart" -}}
...
Common labels
*/}}
{{- define "containerisationv24.labels" -}}
helm.sh/chart: {{ include "containerisationv24.chart" . }}
{{ include "containerisationv24.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
Selector labels
*/}}
{{- define "containerisationv24.selectorLabels" -}}
app.kubernetes.io/name: {{ include "containerisationv24.name" . }}
...
*/}}
{{- define "containerisationv24.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "containerisationv24.fullname" .) .Values.serviceAccount.name }}
{{- else }}
