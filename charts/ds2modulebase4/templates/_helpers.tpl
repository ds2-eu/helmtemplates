...
*/}}
{{- define "ds2modulebase4.fullname" -}}
...
Common labels
*/}}
{{- define "ds2modulebase4.labels" -}}
helm.sh/chart: {{ include "ds2modulebase4.chart" . }}
{{ include "ds2modulebase4.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
Selector labels
*/}}
{{- define "ds2modulebase4.selectorLabels" -}}
app.kubernetes.io/name: {{ include "ds2modulebase4.name" . }}
...
*/}}
{{- define "ds2modulebase4.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "ds2modulebase4.fullname" .) .Values.serviceAccount.name }}
{{- else }}
