...
*/}}
{{- define "ds2connectorv22.fullname" -}}
...
Common labels
*/}}
{{- define "ds2connectorv22.labels" -}}
helm.sh/chart: {{ include "ds2connectorv22.chart" . }}
{{ include "ds2connectorv22.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
Selector labels
*/}}
{{- define "ds2connectorv22.selectorLabels" -}}
app.kubernetes.io/name: {{ include "ds2connectorv22.name" . }}
...
*/}}
{{- define "ds2connectorv22.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "ds2connectorv22.fullname" .) .Values.serviceAccount.name }}
{{- else }}
