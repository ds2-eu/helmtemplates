...
*/}}
{{- define "ds2connectorv21dshare.name" -}}
...
*/}}
{{- define "ds2connectorv21dshare.fullname" -}}
...
*/}}
{{- define "ds2connectorv21dshare.chart" -}}
...
Common labels
*/}}
{{- define "ds2connectorv21dshare.labels" -}}
helm.sh/chart: {{ include "ds2connectorv21dshare.chart" . }}
{{ include "ds2connectorv21dshare.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
Selector labels
*/}}
{{- define "ds2connectorv21dshare.selectorLabels" -}}
app.kubernetes.io/name: {{ include "ds2connectorv21dshare.name" . }}
...
*/}}
{{- define "ds2connectorv21dshare.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "ds2connectorv21dshare.fullname" .) .Values.serviceAccount.name }}
{{- else }}
