...
*/}}
{{- define "ds2modulebase3docker.name" -}}
...
*/}}
{{- define "ds2modulebase3docker.fullname" -}}
...
*/}}
{{- define "ds2modulebase3docker.chart" -}}
...
Common labels
*/}}
{{- define "ds2modulebase3docker.labels" -}}
helm.sh/chart: {{ include "ds2modulebase3docker.chart" . }}
{{ include "ds2modulebase3docker.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
Selector labels
*/}}
{{- define "ds2modulebase3docker.selectorLabels" -}}
app.kubernetes.io/name: {{ include "ds2modulebase3docker.name" . }}
...
*/}}
{{- define "ds2modulebase3docker.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "ds2modulebase3docker.fullname" .) .Values.serviceAccount.name }}
{{- else }}
