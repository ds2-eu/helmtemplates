...
*/}}
{{- define "ds2containerisationv14.name" -}}
...
*/}}
{{- define "ds2containerisationv14.fullname" -}}
...
*/}}
{{- define "ds2containerisationv14.chart" -}}
...
Common labels
*/}}
{{- define "ds2containerisationv14.labels" -}}
helm.sh/chart: {{ include "ds2containerisationv14.chart" . }}
{{ include "ds2containerisationv14.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
Selector labels
*/}}
{{- define "ds2containerisationv14.selectorLabels" -}}
app.kubernetes.io/name: {{ include "ds2containerisationv14.name" . }}
...
*/}}
{{- define "ds2containerisationv14.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "ds2containerisationv14.fullname" .) .Values.serviceAccount.name }}
{{- else }}
