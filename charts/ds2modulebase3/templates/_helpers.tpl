...
*/}}
{{- define "ds2modulebase3.fullname" -}}
...
Common labels
*/}}
{{- define "ds2modulebase3.labels" -}}
helm.sh/chart: {{ include "ds2modulebase3.chart" . }}
{{ include "ds2modulebase3.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
Selector labels
*/}}
{{- define "ds2modulebase3.selectorLabels" -}}
app.kubernetes.io/name: {{ include "ds2modulebase3.name" . }}
...
*/}}
{{- define "ds2modulebase3.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "ds2modulebase3.fullname" .) .Values.serviceAccount.name }}
{{- else }}
