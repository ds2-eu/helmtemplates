...
*/}}
{{- define "ds2connectorv25pae.name" -}}
...
*/}}
{{- define "ds2connectorv25pae.fullname" -}}
...
*/}}
{{- define "ds2connectorv25pae.chart" -}}
...
Common labels
*/}}
{{- define "ds2connectorv25pae.labels" -}}
helm.sh/chart: {{ include "ds2connectorv25pae.chart" . }}
{{ include "ds2connectorv25pae.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
Selector labels
*/}}
{{- define "ds2connectorv25pae.selectorLabels" -}}
app.kubernetes.io/name: {{ include "ds2connectorv25pae.name" . }}
...
*/}}
{{- define "ds2connectorv25pae.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "ds2connectorv25pae.fullname" .) .Values.serviceAccount.name }}
{{- else }}
...
{{- $regurl:= ( include "regurl" . ) }}
{{- (printf "%s/ds2-eu/mkt-%s-%s/%s:%s" $regurl .Values.module.name .Values.module.variant .Values.ds2identityhub.image.name .Values.ds2identityhub.image.tag) }}
{{- end }}
...
{{- $regurl:= ( include "regurl" . ) }}
{{- (printf "%s/ds2-eu/mkt-%s-%s/%s:%s" $regurl .Values.module.name .Values.module.variant .Values.ds2controlplane.image.name .Values.ds2controlplane.image.tag) }}
{{- end }}
...
{{- $regurl:= ( include "regurl" . ) }}
{{- (printf "%s/ds2-eu/mkt-%s-%s/%s:%s" $regurl .Values.module.name .Values.module.variant .Values.ds2dataplane.image.name .Values.ds2dataplane.image.tag) }}
{{- end }}
