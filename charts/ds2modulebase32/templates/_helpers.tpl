...
*/}}
{{- define "ds2modulebase32.fullname" -}}
...
Common labels
*/}}
{{- define "ds2modulebase32.labels" -}}
helm.sh/chart: {{ include "ds2modulebase32.chart" . }}
{{ include "ds2modulebase32.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
Selector labels
*/}}
{{- define "ds2modulebase32.selectorLabels" -}}
app.kubernetes.io/name: {{ include "ds2modulebase32.name" . }}
...
*/}}
{{- define "ds2modulebase32.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "ds2modulebase32.fullname" .) .Values.serviceAccount.name }}
{{- else }}
