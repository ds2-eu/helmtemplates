...
*/}}
{{- define "ds2modulebase5.fullname" -}}
...
Common labels
*/}}
{{- define "ds2modulebase5.labels" -}}
helm.sh/chart: {{ include "ds2modulebase5.chart" . }}
{{ include "ds2modulebase5.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
Selector labels
*/}}
{{- define "ds2modulebase5.selectorLabels" -}}
app.kubernetes.io/name: {{ include "ds2modulebase5.name" . }}
...
*/}}
{{- define "ds2modulebase5.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "ds2modulebase5.fullname" .) .Values.serviceAccount.name }}
{{- else }}
